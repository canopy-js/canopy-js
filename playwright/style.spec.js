...
test.describe('Block entities', () => {
  ...
  test('It allows table lists', async ({ page }) => {
    ...
    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(6)).toHaveText('This is 1/4 card ???????234');
    ...
    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(8)).toHaveText('This is 1/3 card ??? ??? ??? ??? ?23');
    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(9)).toHaveText('4');

    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(10)).toHaveText('This is 1/3 card ??? ??? ??? ??? ??? ??? ??? ??? ?23');
    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(11)).toHaveText('4');

    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(12)).toHaveText('This is 1/2 card ??? ??? ??? ??? ??? ??? ??? ??? ??2');
    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(13)).toHaveText('34');


    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(14)).toHaveText('1. A2. B3. C4. D');

    await expect(page.locator('.canopy-selected-section .canopy-table-list').nth(9)).toHaveAttribute('dir', 'rtl');
    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(15)).toHaveText('ABCD');
    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(16)).toHaveText('EF');

    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(17)).toHaveText('Thisisalongword?ABC');

    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(18)).toHaveText('Thisisalongword??AB');
    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(19)).toHaveText('C');

    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(20)).toHaveText('Thisisalongword?????AB');
    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(21)).toHaveText('C');

    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(22)).toHaveText('Thisisalongword??????A');
    await expect(page.locator('.canopy-selected-section .canopy-table-list .canopy-table-list-row').nth(23)).toHaveText('BC');
  });
