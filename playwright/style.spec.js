...
test.describe('Text styles', () => {
  ...
  test('Topic names can contain italics', async ({ page }) => {
    await page.goto('/United_States/New_York/Style_examples#Style_characters/Italic_topic_names');
  ...
  test('Topic names can contain code snippets', async ({ page }) => {
    await page.goto('/United_States/New_York/Style_examples#Style_characters/Code_snippet_topic_names');
    await page.locator('.canopy-selected-link');
  ...
  test('Topic names can contain literal underscores', async ({ page }) => {
    await page.goto('/United_States/New_York/Style_examples#Style_characters/%5C_Topic_names_with_literal_underscores%5C_');
    await page.locator('.canopy-selected-link');
  ...
  test('Topic names can contain literal backticks', async ({ page }) => {
    await page.goto('/United_States/New_York/Style_examples#Style_characters/%60Topic_names_with_literal_backticks%60');
    await page.locator('.canopy-selected-link');
  ...
  test('Topic names can contain literal backslashes', async ({ page }) => {
    await page.goto('United_States/New_York/Style_examples#Style_characters/Topic_names_with_%5C%5C_backslashes');
    await page.locator('.canopy-selected-link');
  ...
  test('_data is a valid topic name', async ({ page }) => {
    await page.goto('United_States/New_York/Style_examples#Style_characters/%5C_data');
    await page.locator('.canopy-selected-link');
