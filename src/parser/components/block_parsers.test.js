...
test('it parses a list block', () => {
  ...
  expect(result.topLevelNodes[0].indentation).toEqual(0);
  ...
  expect(result.topLevelNodes[0].children[0].indentation).toEqual(2);
  expect(result.topLevelNodes[0].ordered).toEqual(true);
  ...
  expect(result.topLevelNodes[0].children[0].children[0].indentation).toEqual(4);
  expect(result.topLevelNodes[0].ordered).toEqual(true);
  ...
  expect(result.topLevelNodes[0].children[1].indentation).toEqual(2);
  expect(result.topLevelNodes[0].ordered).toEqual(true);
  ...
  expect(result.topLevelNodes[1].indentation).toEqual(0);
  ...
  expect(result.topLevelNodes[1].children[0].indentation).toEqual(2);
...
test('it parses a footnote block', () => {
  ...
  expect(result.footnoteObjects[0].text).toEqual(' This is the first footnote');
  expect(result.footnoteObjects[1].superscript).toEqual('2');
  expect(result.footnoteObjects[1].text).toEqual(' This is the first footnote');
});
