...
Canopy allows an author to express their ideas once, in small modular pieces, with a web interface that combines them to produce an infinite number of customized, user-driven explanations.
